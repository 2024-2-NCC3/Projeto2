...
public class ruth_cardoso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.ruth_cardoso), (v, insets) -> {
        ...
        // Configurar os botões do Instagram e WhatsApp
    ...
    private void criarNoticias() {
        Noticia noticia;
        noticia = new Noticia(
                "https://www.save-free.com/cdn/https://scontent-sin2-1.cdninstagram.com/v/t51.29350-15/466803552_1751955152229960_1634597539392743335_n.jpg?stp=dst-jpg_e35_tt7&efg=eyJ2ZW5jb2xlX3RhZyI6ImltYWdlX3VybGdlbi4xMDgweDEwODAuc2RyLmYyOTM1MC5kZWZhdWx0X2ltYWdlIn0&_nc_ht=scontent-sin2-1.cdninstagram.com&_nc_cat=100&_nc_ohc=DmHum3BC2Q8Q7kNvgGYtPiY&_nc_gid=10da4dd1f0294ef780a3a0eec2bc847e&edm=ANTKIIoBAAAA&ccb=7-5&oh=00_AYBtyYf2EQXTHcnmh3y_-gUbjWMCHCNSgRlSww5tyEO8JQ&oe=673C5E13&_nc_sid=d885a2",
                "AFRO DAY 2024", "13/11/2024",
                "https://gazetadasemana.com.br/noticia/200609/afroday-2024-cultura-afro-brasileira-em-destaque-no-teatro-fecap#google_vignette"
        );
        listaNoticia.add(noticia);

        noticia = new Noticia(
                "https://www.save-free.com/cdn/https://scontent-fra3-1.cdninstagram.com/v/t51.29350-15/387271119_2629011913959927_1666745883246206419_n.jpg?stp=dst-jpg_e15_fr_s1080x1080_tt7&efg=eyJ2ZW5jb2xlX3RhZyI6ImltYWdlX3VybGdlbi4xMDgweDEwODAuc2RyLmYyOTM1MC5kZWZhdWx0X2ltYWdlIn0&_nc_ht=scontent-fra3-1.cdninstagram.com&_nc_cat=103&_nc_ohc=lqCZZKyPvNIQ7kNvgEy-6kY&_nc_gid=85e011578aee415db40faf85483110e5&edm=ANTKIIoBAAAA&ccb=7-5&oh=00_AYDwxXrH-wiZNoJCDG7_pz2du7TWlgkniajCjWbEQIo25g&oe=673C4C82&_nc_sid=d885a2",
                "Missão / Visão / Valores", "02/01/2024",
                "https://www.instagram.com/p/CyPLjCythq2/?igsh=MWg2dDFrcXhubGc5Mw=="
        );
        listaNoticia.add(noticia);
    }
